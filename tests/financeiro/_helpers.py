...
from src.faturamento.lote_faturamento.dtos import LoteFaturamentoCreate
from src.faturamento.lote_faturamento.service import criar_lote
...
def montar_base(session: Session, valor_tabela: Decimal = Decimal("42.00")) -> Base:
    ...
    lote = criar_lote(session, LoteFaturamentoCreate(convenio_id=convenio.id))
